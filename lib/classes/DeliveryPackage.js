...
const PackageIngredient = require("./PackageIngredient.js");
...
/**
 * add ingredients to package post data
 * @param { Obj } ingredient
 */
PostPackage.prototype.addIngredient = function (ingredient) {
    this.Ingredients.push(ingredient);
}

module.exports = { DeliveryPackage, PostPackage };