...
function DeliveryPackage(package) {
    ...
    this.shippedUnitOfMeasureName = product.ShippedUnitOfMeasureName;
    this.receivedQuantity = product.ReceivedQuantity;
    this.receivedUnitOfMeasureName = product.ReceivedUnitOfMeasureName;
}
