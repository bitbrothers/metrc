...
/**
 * Template for post transaction
 * @param { object } {PackageLabel, Quantity, UnitOfMeasure, TotalAmount}
 */
function PostTransaction({PackageLabel, Quantity, UnitOfMeasure, TotalAmount}) {
    this.packageLabel = PackageLabel;
