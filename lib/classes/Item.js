...
function Item(item) {
  const { ItemUnitVolume, ItemUnitVolumeUnitOfMeasureName, ItemUnitWeight, ItemUnitWeightUnitOfMeasureName } = item;

  this.thc = new Concentration(
    item.ItemUnitThcPercent,
    item.ItemUnitThcContent,
    item.ItemUnitThcContentUnitOfMeasureName,
    item.ItemUnitThcContentDose,
    item.ItemUnitThcContentDoseUnitOfMeasureName
  );
  this.cbd = new Concentration(
    item.ItemUnitCbdPercent,
    item.ItemUnitCbdContent,
    item.ItemUnitCbdContentUnitOfMeasureName,
    item.ItemUnitCbdContentDose,
    item.ItemUnitCbdContentDoseUnitOfMeasureName
  );
  ...
  this.itemDimensions = new ItemDimensions({
    ItemUnitVolume,
    ItemUnitVolumeUnitOfMeasureName,
    ItemUnitWeight,
    ItemUnitWeightUnitOfMeasureName,
