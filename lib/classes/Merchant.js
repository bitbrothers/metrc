...
Merchant.prototype.getTransferPackages = async function (delivery) {
  try {
    ...
    return packages = response.data.map(package => {
 ...
 * @param { Function } callback
 */
Merchant.prototype.createPackage = async function (packages, isTestPackage, callback) {
  let url = `${this.packagePath}/create${isTestPackage ? '/testing' : ''}?licenseNumber=${this.licenseNo}`;
  try {
    const response = await http.post(url, packages, {
      username: this.vendorkey,
      password: this.userkey
    });
    callback(response.data);
 ...
 * @param { Function } callback
 */
Merchant.prototype.createPlantingPackage = async function (plantingsData, callback) {
  let url = `${this.packagePath}/create/plantings?licenseNumber=${this.licenseNo}`;
  try {
    const response = await http.post(url, plantingsData, {
      username: this.vendorkey,
      password: this.userkey
    });
    callback(response.data);
 ...
 * @param { Function } callback
 */
Merchant.prototype.changePackageItem = async function (items, callback) {
  let url = `${this.packagePath}/change/item?licenseNumber=${this.licenseNo}`;
  try {
    const response = await http.post(url, items, {
      username: this.vendorkey,
      password: this.userkey
    });
    callback(response.data);
 ...
 * @param { Function } callback
 */
Merchant.prototype.changePackageNote = async function (notes, callback) {
  let url = `${this.packagePath}/change/note?licenseNumber=${this.licenseNo}`;
  try {
    const response = await http.put(url, notes, {
      username: this.vendorkey,
      password: this.userkey
    });
    callback(response.data);
 ...
 * @param { Function } callback
 */
Merchant.prototype.changePackageLocation = async function (locations, callback) {
  let url = `${this.packagePath}/change/locations?licenseNumber=${this.licenseNo}`;
  try {
    const response = await http.post(url, locations, {
      username: this.vendorkey,
      password: this.userkey
    });
    callback(response.data);
 ...
 * @param { Function } callback
 */
Merchant.prototype.adjustPackage = async function (adjustments, callback) {
  let url = `${this.packagePath}/adjust?licenseNumber=${this.licenseNo}`;
  try {
    const response = await http.post(url, adjustments, {
      username: this.vendorkey,
      password: this.userkey
    });
    callback(response.data);
 ...
 * @param { Function } callback
 */
Merchant.prototype.remediatePackage = async function (remediateData, callback) {
  let url = `${this.packagePath}/remediate?licenseNumber=${this.licenseNo}`;
  try {
    const response = await http.post(url, remediateData, {
      username: this.vendorkey,
      password: this.userkey
    });
    callback(response.data);
 ...
 * @param { Function } callback
 */
Merchant.prototype.setFinishedPackage = async function (finishedPackages, callback) {
  let url = `${this.packagePath}/finish?licenseNumber=${this.licenseNo}`;
  try {
    const response = await http.post(url, finishedPackages, {
      username: this.vendorkey,
      password: this.userkey
    });
    callback(response.data);
 ...
 * @param { Function } callback
 */
Merchant.prototype.setUnFinishedPackage = async function (unFinishedPackages, callback) {
  let url = `${this.packagePath}/unfinish?licenseNumber=${this.licenseNo}`;
  try {
    const response = await http.post(url, unFinishedPackages, {
      username: this.vendorkey,
      password: this.userkey
    });
    callback(response.data);
